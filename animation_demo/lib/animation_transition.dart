...
void main() {
  runApp(MaterialApp(
    home: Scaffold(
      ...
      // body: TransitionButton(),
      body: AnimatedWidgetRoute(),
    ),
  ));
}
...
class TransitionButton extends StatefulWidget {
  @override
  _TransitionButtonState createState() => _TransitionButtonState();
}
...
class AnimatedWidgetRoute extends StatefulWidget {
  @override
  _AnimatedWidgetRouteState createState() => _AnimatedWidgetRouteState();
}

class _AnimatedWidgetRouteState extends State<AnimatedWidgetRoute> {
